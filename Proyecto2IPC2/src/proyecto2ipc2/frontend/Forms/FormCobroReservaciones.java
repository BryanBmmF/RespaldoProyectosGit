 ...
 * @author bryan
 */
public class FormCobroReservaciones extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FormCobroReservaciones
     */
    public FormCobroReservaciones(java.awt.Frame parent,Cliente cliente, Hotel hotel,
                                        String fecha, double total, Reservacion reservacion) {
        super(parent, true);
    ...
    private void initComponents() {
        ...
        setTitle("Cobro de Reservaciones");
        setResizable(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtHotel, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel6.setText("Datos de la Reservacion:");
        ...
        tbReservacion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "No.Habitacion", "Precio Habitacion", "Fecha Ingreso", "Fecha Retiro"
            }
        ) {
        ...
        tbReservacion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbReservacionMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tbReservacion);
    ...
    private void tbReservacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbReservacionMouseClicked
        // TODO add your handling code here:

    }//GEN-LAST:event_tbReservacionMouseClicked
    ...
    private void btnGenerarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarFacturaActionPerformed
        // TODO add your handling code here:
            ...
            geenrador.generarReporte("FacturaHotelNueva", lista,total);
    }//GEN-LAST:event_btnGenerarFacturaActionPerformed

    public void rellenarCampos(){
            txtFecha.setText(fecha);
            txtIdHotel.setText(""+hotel.getId());
    ...
    public void cargarTablaReservacion(){
            DefaultTableModel model= (DefaultTableModel)this.tbReservacion.getModel();
            String fechaIngreso= reservacion.getFechaIngreso().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
            String fechaRetiro= reservacion.getFechaRetiro().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
            model.addRow(new Object[]{reservacion.getNumero(),reservacion.getHabitacion().getNumero(),
                                    reservacion.getHabitacion().getPrecio(),fechaIngreso,fechaRetiro});
    }
