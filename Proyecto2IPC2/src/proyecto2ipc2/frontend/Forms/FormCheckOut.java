 ...
 * @author bryan
 */
public class FormCheckOut extends javax.swing.JInternalFrame {
    public static final String COBRAR_RESERVACIONES = "No hay ninguna Reservacion que cobrar"; 
    private ControladorReservacion controladorReserv;
    private ControladorClientes controladorClientes;
    private Reservacion reservacion;
    
    private ControladorHoteles controladorHoteles;
     ...
     */
    public FormCheckOut(JFramePrincipal ventana) {
        this.ventana= ventana;
        this.logger = logger.getInstance();
        this.hotel= new Hotel(logger.getIdEstablecimiento(), logger.getEstablecimiento());
    ...
    private void initComponents() {
        ...
        btnActualizar.setText("Registrar Retiro");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        // TODO add your handling code here:
            if (tbReservaciones.getRowCount()<=0) {
                    JOptionPane.showMessageDialog(null, COBRAR_RESERVACIONES, ERROR_CREACION, JOptionPane.ERROR_MESSAGE);
            } else {
                        //objetos a utilizar
                        ...
                        fechaIngreso = LocalDate.parse(txtFechaIngreso.getText(), DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                        fechaRetiro = LocalDate.parse(txtFechaSalida.getText(), DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                        reservacion= new Reservacion(Integer.parseInt(txtNoReservacion.getText()), cliente, habitacion, fechaIngreso, fechaRetiro,"SALDADA", hotel);
                                        
                        //dias entre las fechas
                        dif= Period.between(fechaIngreso, fechaRetiro);
                        System.out.println(""+dif.getDays());
                        
                        controladorReserv= new ControladorReservacion(reservacion, this);
                        total= controladorReserv.calcularTotalReservacion(dif.getDays());
                        
                        //se registra el monto del ingreso al hotel por la reservacion
                        ingresoHotel= new IngresosHotel(total, fecha, habitacion, hotel, cliente);
                        controladorHoteles= new ControladorHoteles(ingresoHotel, this);
                        controladorHoteles.registrarIngresosHotel();
                        
                        //se actualiza el estado de la reservacion a saldada
                        controladorReserv.actualizarEstadoReservacionSaldada();
                        
                        //visualizar ventana de pago de Reservaciones                   
                        this.formCobroReservaciones= new FormCobroReservaciones(ventana,cliente, hotel, ventana.fechaActualDelSistema2() ,total,reservacion);
                        this.formCobroReservaciones.setVisible(true);
    ...
    public void cargarTablaReservaciones(){
            ...
            List<Reservacion> lista= controladorReserv.recuperarReservacionesClienteRetiro(logger.getIdEstablecimiento(), 
                                            ventana.fechaActualDelSistema(),(String)comboNits.getSelectedItem(),"ACTIVA");
    ...
    private FormCobroReservaciones formCobroReservaciones;
