 ...
 */
package proyecto2compi1.backend.archivos;
...
public class ControladorDeArchivos {
        ...
        private HashMap<String, File> archivosAbiertos = new HashMap<String, File>();
        ...
        public void agregarArchivo(String nombre, File valor){
                archivosAbiertos.put(nombre, valor);
        }
        public File retornarArchivo(String var){
            File valor=null;
            for (String key: archivosAbiertos.keySet()){
                    if (key.equals(var)) {
                        valor =archivosAbiertos.get(key);    
                        break;
                    }
        ...
        public HashMap<String, File> getArchivosAbiertos() {
            return archivosAbiertos;
        }

        public void setArchivosAbiertos(HashMap<String, File> archivosAbiertos) {
