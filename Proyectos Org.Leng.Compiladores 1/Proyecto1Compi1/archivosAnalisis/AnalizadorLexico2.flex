...
//ADICIONALES DE BD
E_SITIO = {S_}{I_}{T_}{I_}{O_}
E_COMPONENTES = {C_}{O_}{M_}{P_}{O_}{N_}{E_}{N_}{T_}{E_}{S_}
E_COMPONENTE = {C_}{O_}{M_}{P_}{O_}{N_}{E_}{N_}{T_}{E_}
E_HIJOS = {H_}{I_}{J_}{O_}{S_}
E_HIJO = {H_}{I_}{J_}{O_}
E_PAGINAS = {P_}{A_}{G_}{I_}{N_}{A_}{S_}
E_PAGINA = {P_}{A_}{G_}{I_}{N_}{A_}
