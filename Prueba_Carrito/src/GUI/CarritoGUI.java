...
import Controllers.ComandosController;
...
public class CarritoGUI extends javax.swing.JFrame {
    ...
    ComandosController controladorArduino;
    com.panamahitek.PanamaHitek_Arduino arduino;
    ...
    public CarritoGUI() throws Exception {
        ...
        controladorArduino = new ComandosController(this.arduino);
    ...
    public void analizarInstruccion(Instruccion instruccion) {
        List<Instruccion> lista = new ArrayList<>();
        try {
            if (instruccion.isInstr2()) {
                if(instruccion.getTipoMovimiento().equals("a")){
                    controladorArduino.adelante(instruccion);
                }else{
                    controladorArduino.atras(instruccion);
                }
            } else {
                controladorArduino.velocidad(instruccion.getVelocidad());
                controladorArduino.moverseConTiempo(instruccion);
            }
            

        } catch (ArduinoException | InterruptedException | SerialPortException e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Limpiar Area Comandos");
        ...
        panelControlLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelControlLayout.createSequentialGroup()
                ...
                .addGroup(panelControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cargarComandos, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                    .addComponent(ejecutarComandos, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                    .addComponent(guardarComandos, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
