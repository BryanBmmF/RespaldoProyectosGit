...
public class parser extends java_cup.runtime.lr_parser {
    ...
    protected static final short _production_table[][]
        ...
        "\000\023\000\002\002\004\000\002\002\003\000\002\010"
        + "\004\000\002\010\003\000\002\007\012\000\002\007\016"
    ...
    protected static final short[][] _action_table
            = unpackFromStrings(new String[]{
        "\000\041\000\004\004\006\001\002\000\006\002\ufffe\004"
        ...
        + "\ufff4\001\002\000\004\007\025\001\002\000\012\010\031"
        + "\011\030\012\027\022\023\001\002\000\004\006\042\001"
        + "\002\000\004\006\ufff1\001\002\000\004\006\ufff2\001\002"
        + "\000\004\006\ufff3\001\002\000\004\007\033\001\002\000"
        + "\006\015\035\016\034\001\002\000\004\007\ufff0\001\002"
        + "\000\004\007\uffef\001\002\000\004\007\037\001\002\000"
        + "\010\010\031\011\030\012\027\001\002\000\004\006\041"
    ...
    protected static final short[][] _reduce_table
            = unpackFromStrings(new String[]{
        "\000\041\000\010\002\006\007\003\010\004\001\001\000"
        ...
        + "\000\002\001\001\000\002\001\001\000\006\003\031\005"
        ...
        public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
            ...
            switch (CUP$parser$act_num) {
                ...
                case 4: // instruction ::= INSTRUCCION PARENTESIS_ABIERTO tipo_movimiento COMA tiempo COMA velocidad PARENTESIS_CERRADO 
                {
                    ...
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("instruction", 5, ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 7)), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                }
                return CUP$parser$result;

                /*. . . . . . . . . . . . . . . . . . . .*/
                case 5: // instruction ::= INSTRUCCION PARENTESIS_ABIERTO tipo_movimiento COMA tiempo COMA tiempo COMA lado COMA velocidad PARENTESIS_CERRADO 
                {
                    Instruccion RESULT = null;
                    int tipoMovimientoleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 9)).left;
                    int tipoMovimientoright = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 9)).right;
                    String tipoMovimiento = (String) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 9)).value;
                    int distancialeft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 7)).left;
                    int distanciaright = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 7)).right;
                    Integer distancia = (Integer) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 7)).value;
                    int anguloleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 5)).left;
                    int anguloright = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 5)).right;
                    Integer angulo = (Integer) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 5)).value;
                    ...
                    String lado = (String) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 3)).value;
                    int velocidadleft = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).left;
                    int velocidadright = ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).right;
                    String velocidad = (String) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).value;

                    RESULT = new Instruccion(tipoMovimiento, distancia, angulo, lado, velocidad);

                    CUP$parser$result = parser.getSymbolFactory().newSymbol("instruction", 5, ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 11)), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                }
                return CUP$parser$result;

                /*. . . . . . . . . . . . . . . . . . . .*/
                case 6: // tipo_movimiento ::= ADELANTE 
                {
                    String RESULT = null;
                    RESULT = "a";
                ...
                /*. . . . . . . . . . . . . . . . . . . .*/
                case 8: // tipo_movimiento ::= IZQUIERDA 
                {
                    String RESULT = null;
                    RESULT = "b";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("tipo_movimiento", 2, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                ...
                /*. . . . . . . . . . . . . . . . . . . .*/
                case 9: // tipo_movimiento ::= DERECHA 
                {
                    String RESULT = null;
                    RESULT = "d";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("tipo_movimiento", 2, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                ...
                /*. . . . . . . . . . . . . . . . . . . .*/
                case 11: // tipo_movimiento ::= ENCENDER 
                {
                    String RESULT = null;
                    RESULT = "f";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("tipo_movimiento", 2, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                ...
                /*. . . . . . . . . . . . . . . . . . . .*/
                case 12: // tipo_movimiento ::= APAGAR 
                {
                    String RESULT = null;
                    RESULT = "g";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("tipo_movimiento", 2, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                ...
                /*. . . . . . . . . . . . . . . . . . . .*/
                case 17: // lado ::= DERECHA 
                {
                    String RESULT = null;
                    RESULT = "d";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("lado", 4, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
                }
                return CUP$parser$result;

                /*. . . . . . . . . . . . . . . . . . . .*/
                case 18: // lado ::= IZQUIERDA 
                {
                    String RESULT = null;
                    RESULT = "b";
                    CUP$parser$result = parser.getSymbolFactory().newSymbol("lado", 4, ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), ((java_cup.runtime.Symbol) CUP$parser$stack.peek()), RESULT);
