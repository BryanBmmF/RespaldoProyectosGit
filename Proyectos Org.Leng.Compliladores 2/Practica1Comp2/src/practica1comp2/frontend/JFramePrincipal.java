    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
            ...
            */
            ...
            txtInterpretacion.setText("");//limpiando area de mensajes

            System.out.println("Entrada a parsear: "+entrada);
            this.lexer.yyreset(new StringReader(entrada));
            try {
                    List<Instruccion> list = (List<Instruccion>)this.parser.parse().value;
                    //recorriendo lista
                    if (list!=null) {
                        if (!list.isEmpty()) {
            ...
            if (this.lexer.getErrorsList().isEmpty()) {
                gen.imprimirCod(txtInterpretacion);
            } else {
