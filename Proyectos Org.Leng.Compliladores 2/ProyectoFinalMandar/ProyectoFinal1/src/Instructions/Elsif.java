 ...
 * @author jpmazate
 */
public class Elsif implements Instruction {
    ...
    public Elsif(ExpresionBooleana condicion, List<Instruction> instructions,Token token, TablaSimbolos tablaSimbolos, TablaTipos tablaTipos) {
        this.condicion = condicion;
        this.instructions = instructions;
        this.token = token;this.tablaSimbolos = tablaSimbolos;
    ...
    public boolean validate() {
        ...
        if(!bandera2){
             CErrores.agregarError("SEMANTICO", "ELSIF", null, null, null,
                            token.getLine(), token.getColumn(),
                            "PROBLEMAS CON EL CONTROL DE FLUJO ELSIF");
