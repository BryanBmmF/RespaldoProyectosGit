...
public class Print implements Instruction{
    ...
    public Print(List<Expresion> lista, TablaSimbolos tablaSimbolo, TablaTipos tablaTipos,Token token) {
        this.lista = lista;
    ...
    public boolean validate() {
        ...
        if(!bandera){
             CErrores.agregarError("SEMANTICO", "PRINT", null, null, null,
                            token.getLine(), token.getColumn(),
                            "PROBLEMAS CON LA SENTENCIA PRINT");
    ...
    public List<Cuarteto> execute() {
        ...
        for (int i = 0; i <this.lista.size(); i++) {
            ...
            lista.add(Cuarteto.MakePrint(valor,tipo));
        }
